    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience_level', models.CharField(choices=[('beginner', 'Beginner (0-1 years)'), ('intermediate', 'Intermediate (2-4 years)'), ('advanced', 'Advanced (5+ years)')], default='beginner', max_length=20)),
